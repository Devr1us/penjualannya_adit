...
class ProdukAdapter(
    ...
    override fun onBindViewHolder(holder: ProdukViewHolder, position: Int) {
        ...
        // Pengecekan manual untuk menghindari error unresolved atau type mismatch
        holder.tvKategoriProduk.text = if (produk.kategoriNama.isNullOrEmpty()) "-" else produk.kategoriNama
        holder.tvCabang.text        = if (produk.cabangNama.isNullOrEmpty()) "Utama" else produk.cabangNama
