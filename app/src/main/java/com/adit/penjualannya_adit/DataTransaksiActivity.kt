...
class DataTransaksiActivity : AppCompatActivity() {
    ...
    private fun filterProduk() {
        ...
        val filtered = listProduk.filter { produk ->
            val matchKategori = selectedKategoriId == "Semua" || produk.kategoriId == selectedKategoriId
            val matchSearch = produk.namaProduk.lowercase().contains(query) ||
    ...
    private fun saveTransaction() {
        ...
        val transaksi = ModelTransaksi(
            ...
            tanggal = date, namaPegawai = "Kasir", metodePembayaran = metodePembayaran
        )
